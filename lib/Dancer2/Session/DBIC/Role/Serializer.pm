...
Options to be based to the C<new> method of the underlying serializer class
as a hash reference.
...
Options to be based to the C<new> method of the underlying deserializer class
as a hash reference.
